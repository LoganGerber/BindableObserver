...
var BindableObserver = /** @class */ (function () {
     ...
     */
    function BindableObserver(eventEmitterType) {
        var args = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args[_i - 1] = arguments[_i];
        }
        this.internalEmitter = new (eventEmitterType.bind.apply(eventEmitterType, __spreadArrays([void 0], args)))();
        this.relays = [];
        this.idCache = [];
    ...
    BindableObserver.prototype.addListener = function (event, listener) {
        var eventName = BindableObserver.getRegisterableEventName(event);
