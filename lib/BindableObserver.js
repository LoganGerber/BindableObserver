...
exports.BindableObserver = exports.RelayFlags = exports.UndefinedInternalEmitterError = exports.EmitEvent = exports.Event = void 0;
...
var UndefinedInternalEmitterError_1 = require("./UndefinedInternalEmitterError");
Object.defineProperty(exports, "UndefinedInternalEmitterError", { enumerable: true, get: function () { return UndefinedInternalEmitterError_1.UndefinedInternalEmitterError; } });
/**
...
var BindableObserver = /** @class */ (function () {
    ...
    function BindableObserver(eventEmitter) {
        ...
        if (eventEmitter) {
            this.setInternalEmitter.apply(this, __spreadArrays([eventEmitter], args));
        }
    }
    /**
     ...
     */
    BindableObserver.prototype.getInternalEmitter = function () {
     ...
     */
    BindableObserver.prototype.setInternalEmitter = function (eventEmitter) {
        var args = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args[_i - 1] = arguments[_i];
        }
    ...
    BindableObserver.prototype.emit = function (event) {
        if (this.internalEmitter === undefined) {
            throw new UndefinedInternalEmitterError_1.UndefinedInternalEmitterError();
        }
