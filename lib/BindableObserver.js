...
exports.BindableObserver = exports.ObserverUnboundEvent = exports.ObserverBoundEvent = exports.CacheLimitChangedEvent = exports.ListenerRemovedEvent = exports.ListenerBoundEvent = exports.EmitterChangedEvent = exports.UndefinedEmitterError = exports.EmitEvent = exports.Event = void 0;
...
var BindableObserver = /** @class */ (function () {
     ...
     */
    BindableObserver.getEventSymbol = function (event) {
        var constructor;
        if (typeof event === "function") {
            constructor = event;
        }
        ...
        if (!BindableObserver.symbolMap.has(constructor)) {
            var symbol = Symbol(BindableObserver.getRegisterableEventName(event));
            BindableObserver.symbolMap.set(constructor, symbol);
            BindableObserver.inverseSymbolMap.set(symbol, constructor);
        }
        return BindableObserver.symbolMap.get(constructor);
    };
    ...
    BindableObserver.prototype.emit = function (event) {
        ...
        var ret = this.emitter.emit(BindableObserver.getEventSymbol(event), event);
    ...
    BindableObserver.prototype.on = function (event, listener) {
        ...
        var eventName = BindableObserver.getEventSymbol(event);
    ...
    BindableObserver.prototype.removeAllListeners = function (event) {
        ...
        if (event) {
            ...
            for (var _d = 0, _e = this.emitter.eventNames(); _d < _e.length; _d++) {
                ...
                if (typeof event_1 === "symbol" && (eventType = BindableObserver.inverseSymbolMap.get(event_1))) {
     ...
     */
    BindableObserver.symbolMap = new Map();
    /**
     * Map that relates each symbol to the Event that was used to generate it.
     */
    BindableObserver.inverseSymbolMap = new Map();
    BindableObserver.emitEventSymbol = BindableObserver.getEventSymbol(EmitEvent_1.EmitEvent);
